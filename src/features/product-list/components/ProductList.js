...
export default function Product() {
  ...
  return (
    <div className="bg-white">
      <div>
        <MobileView handlerSort={handlerSort} mobileFiltersOpen={mobileFiltersOpen} handleFilter={handleFilter} setMobileFiltersOpen={setMobileFiltersOpen} ></MobileView>
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              {/* Product grid */}
              <PageGrid products={products}></PageGrid>
            </div>
          </section>
        </main>
...
function MobileView({ handlerSort,setMobileFiltersOpen, mobileFiltersOpen,handleFilter }) {
  return (
                  ...
                  <div className="mt-4 flex justify-between">
                    <div>
                      ...
                      <div className='flex space-x-2'>
                        <span className='inline text-yellow-500'><StarIcon className='w-5 h-6' /></span>
                        <p className="mt-1 inline text-sm text-gray-500">{product.rating}</p>
                      </div>
                    </div>
                    <div>
